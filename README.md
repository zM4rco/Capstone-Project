...
To build a Wi-Fi heat mapping tool that can be used to determine Wi-Fi signal strengths of routers/wireless access points and then generate heatmaps of the Wi-Fi network coverage.
